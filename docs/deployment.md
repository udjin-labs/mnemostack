...
- **Rotate externally.** The file grows without bound — point logrotate at it. Appends are `flock`-serialized (CLI + console never interleave), the file is created `0o640`, and readers skip-and-count a line truncated by a copytruncate rotation.
